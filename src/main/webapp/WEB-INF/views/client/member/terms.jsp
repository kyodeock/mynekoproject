...
종이에 출력된 개인정보는 분쇄기로 분쇄하거나 소각을 통하여 파기합니다. 전자적 파일 형태로 저장된 개인정보는 기록을 재생할 수 없는 기술적 방법을 사용하여 삭제합니다.
				...
				<p>
					<input type="checkbox" id="check_1" name="checkOne" class="check" /> 위의 약관에 동의 합니다.<br />
				</p>
...
1. 이 약관은 2014년 03월 01일부터 적용됩니다.
				...
				<p>
					<input type="checkbox" id="check_2" name="checkOne" class="check" /> 위의 약관에 동의 합니다.<br />
				</p>
...
- 개인정보의 처리를 위탁하거나 제공하는 경우에는 수탁자, 수탁범위, 공유 정보의 범위 등에 관한 사항을 서면, 전자우편, 전화 또는 홈페이지를 통해 미리 이용자에게 고지합니다
				...
				<p>
					<input type="checkbox" id="check_3" name="checkOne" class="check" /> 위의 약관에 동의 합니다.<br />
					<input type="checkbox" id="checkAll" name="checkAll" />약관 전체동의<br />
	...
	<script type="text/javascript">
		$(document).ready(function() {
			...
			selectAll.addEventListener("click", function() {
				var objs=document.querySelectorAll(".check");
