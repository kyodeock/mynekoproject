...
<body id="header">
	<div>
		...
		<div id="member">
			<div>
				<strong><%=session.getAttribute("m_name")%>님</strong> 안녕하세요 <strong id="m_mileage">가용 마일리지:<%=session.getAttribute("m_mileage") %></strong>
			</div>
			...
			<div>
				<a href="/member/modifi"> 회원정보수정 </a><a
					href="/myorder/myorderList">나의결제내역 </a>
			</div>
			<div>
				<a
